...
{{--            <div class="row">--}}
{{--                <div class="col-8">--}}
{{--                    <div class="col-12 d-inline-flex"><strong>{{trans('dashboard.supplier_management_supplier_name')}}: </strong> {{$suppliers->supplier_name}}</div>--}}
{{--                    <div class="col-12 d-inline-flex"><strong>{{trans('dashboard.supplier_management_phone')}}: </strong> {{$suppliers->phone_1}}</div>--}}
{{--                    <div class="col-12 d-inline-flex"><strong>{{trans('dashboard.supplier_management_address')}}: </strong> {{$suppliers->address}}</div>--}}
{{--                </div>--}}
{{--                <div class="col-4">--}}
{{--                    <strong>Date: <span>{{$purchase_order->created_at->format('d F Y')}}</span></strong>--}}
{{--                </div>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--            <tr>--}}
{{--                <td>{{$key + 1}}</td>--}}
{{--                <td>{{$purchase_order_detail->product->product_name}}</td>--}}
{{--                <td>{{$purchase_order_detail->unit->unit_name}}</td>--}}
{{--                <td>{{$purchase_order_detail->purchase_amount}}</td>--}}
{{--                <td>{{$purchase_order_detail->quantity}}</td>--}}
{{--                <td>{{$purchase_order_detail->selling_amount}}</td>--}}
{{--                <td>{{($purchase_order_detail->quantity) * ($purchase_order_detail->purchase_amount)}}</td>--}}
{{--            </tr>--}}
{{--        @endforeach--}}
{{--        </tbody>--}}
{{--    </table>--}}
...
{{--                    <div class="card-body">--}}
{{--                        <ul class="list-group">--}}
{{--                            <li class="list-group-item">{{trans('dashboard.voucher_management_discount')}}: {{$purchase_order->discount??''}}</li>--}}
{{--                            <li class="list-group-item">{{trans('dashboard.voucher_management_extra_charge')}}:{{$purchase_order->extra_charge??''}}</li>--}}
{{--                            <li class="list-group-item">{{trans('dashboard.supplier_management_total_bill')}}: {{$purchase_order->billing_amount??''}}</li>--}}
{{--                            <li class="list-group-item">{{trans('dashboard.supplier_management_bill_paid')}}: {{$purchase_order->paid_amount??''}}</li>--}}
{{--                            <li class="list-group-item">{{trans('dashboard.purchase_management_return_amount')}}: {{$purchase_order->change_amount??''}}</li>--}}
{{--                        </ul>--}}
{{--                    </div>--}}
{{--                </div>--}}
{{--            </div>--}}
                ...
                <div class="card-body p-0">
                    ...
                    <div class="row">
                        <div class="col-md-6 py-2" style="padding-left:25px">
                            <p class="font-weight-bold mb-1" style="font-family: 'Kalpurush', sans-serif;"><u>{{trans('dashboard.supplier_information')}}</u></p>
                            <p class="mb-0" style="font-family: 'Kalpurush', sans-serif;">{{$suppliers->supplier_name}}</p>
                            <p class="mb-0" style="font-family: 'Kalpurush', sans-serif;">{{$suppliers->phone_1}}</p>
                            <p class="mb-0" style="font-family: 'Kalpurush', sans-serif;">{{$suppliers->address}}</p>
                        </div>

                        <div class="col-md-6 text-right" style="padding-right: 25px">
                            <p class="mb-1"><span class="text-dark" style="font-family: 'Kalpurush', sans-serif;">{{trans('dashboard.date')}}: </span>{{$purchase_order->created_at->format('d F Y')}}</p>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <th class="border-0 text-uppercase small font-weight-bold" style="font-family: 'Kalpurush', sans-serif;">{{trans('dashboard.purchase_price')}} </th>
