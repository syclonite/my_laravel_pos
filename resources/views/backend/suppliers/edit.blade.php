...
@section('content')
    <div class="row">
        <div class="col-lg-6 margin-tb">
            <div class="pull-left">
                <h2>{{trans('dashboard.supplier_management_phone')}}</h2>
            </div>
        ...
        <div class="row">
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Name" value="{{$supplier->supplier_name}}" required>
                </div>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
                    <strong>{{trans('dashboard.supplier_management_phone')}}:</strong>
                    <input class="form-control" type="number" name="phone" placeholder="Phone" id="phone" value="{{$supplier->phone_1}}" required>
                </div>
            </div>
            <div class="col-xs-6 col-sm-6 col-md-6">
                <div class="form-group">
